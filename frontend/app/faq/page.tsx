...
const faqs: { q: string; a: React.ReactNode }[] = [
  ...
  },
  {
    ...
    a: (
      <>
        因为<strong>长对话比一次性指令好</strong>。一个好的规划需要 10-20 分钟的来回问答:
        你的目标、每日时长、基础、弱点、资源偏好...Claude / Gemini / DeepSeek 在这种"慢聊"上比我们自己做的 prompt 稳。
        <br />
  ...
  {
    q: "CCO 只适合学生/备考吗?工作技能提升能用吗?",
    a: (
      <>
        适合。只要你的目标满足三条就能用:
        <ul className="list-disc list-inside space-y-1 mt-2 ml-2">
          <li>
            <strong>有明确产出</strong>(不是"想变厉害",是"能独立做 X")
          </li>
          <li>
            <strong>能拆分成每日动作</strong>(可以每天做 30 分钟-几小时)
          </li>
          <li>
            <strong>网上资源充足</strong>(有教程 / 书 / 视频 / 练习工具)
          </li>
        </ul>
        典型场景:备考(雅思/GRE/考研/CFA/驾考)、技能转岗(前端/SQL/数据分析)、
        语言训练、求职准备、工作能力(演讲/会议主持/项目管理)...都 OK。
      </>
    ),
  },
  {
